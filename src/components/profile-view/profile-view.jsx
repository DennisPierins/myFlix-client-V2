...
export class ProfileView extends React.Component {
  ...
  getUser(token) {
    ...
    axios
      .get(`https://themyflixapi.herokuapp.com/users/${userId}`, {
  ...
  deleteUser() {
    ...
    axios
      .delete(`https://themyflixapi.herokuapp.com/users/${userId}`, {
        headers: { Authorization: `Bearer ${token}` },
      })
      .then((res) => {
      ...
      <Container>
        ...
        <Container className="fav-container">
          <Card style={{ width: "50rem" }}>
            <Card.Header as="h5">Your Favorite Movies</Card.Header>
            <Row>
